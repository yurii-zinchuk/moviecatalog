...
import com.zinchuk.domain.usecases.*
...
class AllMoviesViewModelTest {
    ...
    @Test
    fun `loadMovies should emit Success state with data`() = runTest {
        // Arrange
    ...
    @Test
    fun `onLoadError should emit Error state with cached data`() = runTest {
        // Arrange
    ...
    @Test
    fun `onToggleFavorite should call addFavorite when not favorite`() = runTest {
        // Arrange
        val pagingData = PagingData.from(listOf(dummyMovie))
    ...
    @Test
    fun `onToggleFavorite should call removeFavorite when already favorite`() = runTest {
        // Arrange

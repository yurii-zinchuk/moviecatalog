...
import com.zinchuk.data.mappers.*
...
class MovieRepositoryImplTest {
    ...
    @Test
    fun `getCachedMovies should return mapped domain objects`() = runTest {
        // Arrange
    ...
    @Test
    fun `addFavorite should call local data source with mapped entity`() = runTest {
    ...
    @Test
    fun `removeFavorite should call local data source with mapped entity`() = runTest {
        val favEntity = mockk<MovieFavouriteEntity>()
        every { domainToFavEntityMapper.map(dummyMovie) } returns favEntity
    ...
    @Test
    fun `isFavorite should return correct result`() = runTest {
    ...
    @Test
    fun `getFavoriteMovies should return mapped domain list`() = runTest {
    ...
    @Test
    fun `getFavoriteMoviesPaged should return paged mapped results`() = runTest {
        val favEntity = mockk<MovieFavouriteEntity>()
